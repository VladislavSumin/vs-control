...
internal class NavigationGraphImpl(
    ...
    override fun <P : ScreenParams> findFactory(screenKey: KClass<P>): ScreenFactory<P, out Screen>? {
     ...
     */
    private fun findRootScreen(repository: NavigationRepository): KClass<out ScreenParams> {
