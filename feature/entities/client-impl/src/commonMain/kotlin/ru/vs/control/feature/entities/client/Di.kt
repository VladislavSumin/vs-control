...
import ru.vs.control.feature.entities.client.ui.entities.booleanEntityState.BooleanEntityStateComponentFactory
...
fun Modules.featureEntities() = DI.Module("feature-entities") {
    ...
    // TODO написать короткий экстеншен для этого
