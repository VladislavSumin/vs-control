...
/**
 * Основной класс клиента rSub. Он передается в конструктор прокси классов генерируемых через [RSubClientInterfaces]
 *
...
open class RSubClient(
    ...
    suspend inline fun <reified T : Any> processSuspend(
    ...
    @Suppress("TooGenericExceptionCaught")
    @PublishedApi
    internal suspend fun <T : Any> processSuspend(
        interfaceName: String,
        methodName: String,
        type: KType,
        argumentsTypes: List<KType>,
    ...
    inline fun <reified T : Any> processFlow(
        interfaceName: String,
        methodName: String,
        argumentsTypes: List<KType>,
        arguments: List<Any?>,
    ...
    @Suppress("TooGenericExceptionCaught")
    @PublishedApi
    internal fun <T : Any> processFlow(
        interfaceName: String,
        methodName: String,
        type: KType,
        argumentsTypes: List<KType>,
